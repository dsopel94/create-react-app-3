!(function(e) {
  ...
  }), (t.p = '/create-react-app-3/build/'), t((t.s = 314));
})([
  function(e, t, n) {
    'use strict';
  ...
  function(e, t, n) {
    ...
    function r(e) {
      return function(t) {
        d.a
          .get('//whispering-badlands-12485.herokuapp.com/courses/' + e)
          .then(function(e) {
    ...
    function s(e) {
      return function(t) {
        d.a
          .get('//whispering-badlands-12485.herokuapp.com/students/' + e)
          .then(function(e) {
            console.log(
              e.data,
    ...
    function u(e) {
      return function(t) {
        d.a
          .delete('//whispering-badlands-12485.herokuapp.com/students/' + e)
          .then(function(e) {});
      };
    }
    function c(e) {
      return function(t) {
        d.a
          ...
          .then(function(e) {
            (window.location.href = '/create-react-app-3/build/auth/dashboard'), t({ type: p.b, payload: e.data.courses });
          });
      };
    }
    function l(e, t) {
      return function(n) {
        d.a
          .put('//whispering-badlands-12485.herokuapp.com/courses/' + t, {
            name: e,
          })
          .then(function(e) {
            console.log(
              e.data.courses
            ), (window.location.href = '/create-react-app-3/build/courses/' + e.data.courses._id);
          });
      };
    }
    ...
    var p = n(20),
      ...
      y = function(e, t, n) {
        ...
        return function(r) {
          console.log(
            ...
            .post(
              '//whispering-badlands-12485.herokuapp.com/api/auth/register',
              { username: e, fullName: t, password: n }
            )
            .then(function(e) {
              window.location.href = '/create-react-app-3/build/login';
            });
        };
      },
          ...
          d.a
            ...
            .then(function(s) {
              a({
                ...
                streetAddress: r,
                miscAddress: o,
              }), (window.location.href = '/create-react-app-3/build/courses/' + i), console.log(window.location.href), console.log(s.data.students, 'Student response');
            });
        };
      },
      b = function(e, t, n, r, o, i) {
        return function(a) {
          d.a
            .put('//whispering-badlands-12485.herokuapp.com/students/' + i, {
              firstName: e,
              lastName: t,
              phoneNumber: n,
              streetAddress: r,
            ...
            .then(function(e) {
              console.log(
                e.data.students,
                'Checking after put'
              ), (window.location.href = '/create-react-app-3/build/courses/' + e.data.students.courses);
            });
        };
      },
      w = function(e, t) {
          ...
          n({ type: p.h, username: e, password: t }), d.a
            ...
            .then(function(e) {
              v.set('token', e.data.token, {
                path: '/create-react-app-3/build/',
                maxAge: 86400,
              }), v.set('instructor', e.data.instructor, { path: '/create-react-app-3/build/', maxAge: 86400 }), console.log(v.get('instructor')), n({ type: p.i, fullName: e.data.instructor.fullName });
            })
            .catch(function(e) {
              n({
                type: p.j,
        ...
        return function(n) {
          d.a
            ...
            .then(function(t) {
              v.get(
                'instructor'
              ), n({ type: p.f, coursename: e, _creator: v.get('instructor')._id, periods: [] }), (window.location.href = '/create-react-app-3/build/auth/dashboard');
            });
        };
      };
  },
            ...
            value: function() {
              return !0 === this.props.authenticated
                ? s.a.createElement(p.c, {
                    to: '/create-react-app-3/build/auth/dashboard',
                  })
        ...
        return a(t, e), p(t, [
          {
            ...
            value: function(e) {
              ...
              }), (window.location.href = '/create-react-app-3/build/editStudent/' +
                this.props.id);
            },
          },
          {
            ...
            value: function(e) {
              e.preventDefault(), this.setState({
                ...
                e.target.id,
                'Check target id'
              ), (window.location.href = '/create-react-app-3/build/courses/' +
                this.props.courses);
            },
          },
          {
        ...
        o.a.createElement(
          ...
          o.a.createElement(
            ...
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-3/build/login',
              component: c.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
            ...
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-3/build/auth/dashboard',
              component: l.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-3/build/addCourse',
              component: b.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-3/build/courses/:cuid',
              component: w.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-3/build/addStudent/:cuid',
              component: _.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-3/build/editStudent/:cuid',
              component: E.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-3/build/editCourse/:cuid',
              component: C.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-3/build/info',
              component: x.a,
            })
          )
        )
                      ...
                      s.a.createElement(
                        ...
                        s.a.createElement(
                          ...
                          s.a.createElement(
                            p.b,
                            {
                              to: '/create-react-app-3/build/login',
          ...
          },
          {
            ...
            value: function() {
              return this.state.isSubmitted
                ? s.a.createElement(l.c, {
                    to: '/create-react-app-3/build/courses/' +
                  ...
                  s.a.createElement(
                    ...
                    s.a.createElement(
                      ...
                      s.a.createElement(
                        l.b,
                        {
                          to: '/create-react-app-3/build/addStudent/' +
                            this.props.match.params.cuid,
                        },
                        'Add a new student'
                      )
                    ...
                    s.a.createElement(
                      ...
                      s.a.createElement(
                        l.b,
                        {
                          to: '/create-react-app-3/build/editCourse/' +
                            this.props.match.params.cuid,
                        },
                        'Edit Course Name'
                      )
        ...
        return i(t, e), h(t, [
          {
            key: 'onClick',
            value: function(e) {
              e.preventDefault(), (window.location = '/create-react-app-3/build/courses/' +
                e.target.id);
            },
          },
          {
          ...
          },
          {
            ...
            value: function() {
              var e = this;
              this.state.authenticated ||
                (window.location.href = '/create-react-app-3/build/login'), console.log(
                this.state.authenticated,
                ...
                s.a.createElement(
                  ...
                  s.a.createElement(
                    ...
                    s.a.createElement(
                      ...
                      s.a.createElement(
                        f.b,
                        { to: '/create-react-app-3/build/addCourse' },
                        'Add a new course '
                      )
                    ),
                    s.a.createElement(
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              ...
              o.a.createElement(
                ...
                o.a.createElement(
                  s.b,
                  { to: '/create-react-app-3/build/info' },
                  'Click here'
                ),
                ' '
              )
      ...
      'serviceWorker' in navigator &&
        window.addEventListener('load', function() {
          navigator.serviceWorker
            .register('/create-react-app-3/build/service-worker.js')
            .then(function(e) {
  ...
  function(e, t, n) {
    ...
    (function(t) {
      ...
      'undefined' !== typeof t &&
        n.i({
          NODE_ENV: 'production',
          PUBLIC_URL: '/create-react-app-3/build',
        });
      var u = {
...
//# sourceMappingURL=main.583cf057.js.map
